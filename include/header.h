...
char           * teeny_header_get_name  (teeny_header_t *header);
char           * teeny_header_get_value (teeny_header_t *header);
void             teeny_header_set_name  (teeny_header_t *header, char *name);
void             teeny_header_set_value (teeny_header_t *header, char *value);
